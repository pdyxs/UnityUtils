...
/// 
/// 2013 Tim Tregubov
/// Alterd to turn into extension methods
/// </summary>
public static class CoroutineUtils
{
    private static Dictionary<MonoBehaviour, LockQueue> LockedCoroutineQueues = new Dictionary<MonoBehaviour, LockQueue>();

    /// <summary>
    /// Coroutine with return value AND exception handling on the return value. 
    /// </summary>
    public static Coroutine<T> StartCoroutine<T>(this MonoBehaviour mb, IEnumerator coroutine)
    {
